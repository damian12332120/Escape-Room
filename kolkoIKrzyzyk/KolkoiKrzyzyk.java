package escapeRoom.kolkoIKrzyzyk;
...
public class KolkoiKrzyzyk {
    ...
    public static boolean menu() {
        wyznaczenieZnaku = 1;
        if (!rozruchGryGraczIKomputer()) {
            return false;
        }
        return true;
    }

    public static boolean rozruchGryGraczIKomputer() {
        wyswietlaniePlanszy();
        do {
            ruchGracza();
            ruchKomutera();
    ...
    public static void wskazPole() {
        ...
        System.out.println("\nPodaj pole do zaznaczenia. Pamiętaj, pierwszy znak to liczba, drugi to litera");
